#+title: sml-rmath: SML library for the Rmath library with implementations in MLton, Poly/ML, Moscow ML (MosML), SML# and Manticore
...
I have not yet implemented the library in [[https://www.smlnj.org/][SML/NJ]] or [[https://www.ps.uni-saarland.de/alice/][Alice]] as my development platform is 64-bit.
